                                ...
                                <tbody>
                                    @foreach ($categories as $categorie)
                                        <tr>
                                            ...
                                            <td>
                                                <a data-toggle="modal" data-target="#modal-delete-{{ $categorie->id }}" type="button" class="btn btn-danger">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="name" value="{{ $categorie->name }}" class="form-control @error('name') is-invalid @enderror">
                                                                        @error('name')
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="color" name="color" value="{{ $categorie->color }}" class="form-control @error('color') is-invalid @enderror" value="#e17070 ">
                                                                        @error('color')
                                                                                <div class="text-danger">{{ $message }}</div>
                                                                            @enderror
                                                                    </div>
                                        ...
                                        <div class="modal fade" id="modal-delete-{{ $categorie->id }}" aria-modal="true"
                                            role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <form method="POST"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12 bp-3">
                                                                    Are you sure you want delete categorie {{ $categorie->name }}?
                                                                </div>
                                                                <div class="col-12 d-flex justify-content-end gap-5">
                                                                    <button type="button" class="btn btn-default mr-3"
                                                                        data-dismiss="modal">Close</button>
